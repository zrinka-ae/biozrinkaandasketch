...
.hero-text {
  position: absolute;
  top: 0;
  bottom: 72%;          /* confines the box to the sky zone */
  left: 0;
  right: 0;
  z-index: 10;
  display: flex;
...
<section class="hero">
  ...
  -->
  <svg class="hero-scene" viewBox="0 0 1400 900" preserveAspectRatio="xMidYMax slice"
    ...
    <!-- ── SKY ── -->
    <rect width="1400" height="900" fill="url(#gSky)"/>
